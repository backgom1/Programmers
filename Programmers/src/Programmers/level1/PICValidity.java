...
public class PICValidity {

    static Map<String, Integer> termsDates = new HashMap<>();

    public static void main(String[] args) {
        String today = "2020.12.17";
        String[] terms = new String[]{"A 12"};
        String[] privacies = new String[]{"2010.01.01 A", "2019.12.17 A"};
        PICValidity sol = new PICValidity();
        int[] solution = sol.solution(today, terms, privacies);
        for (int i : solution) {
